...
export const getPage = (): string => {
    ...
    const meta: HTMLMetaElement = document.querySelector('meta[name="page:url"]') as HTMLMetaElement;

    a.href = meta.getAttribute("content") as string;
    return a.pathname;
};

export const navigate = (page: string, portfolio: Portfolio, posts: IPost[]): void => {
...
export const init = (document: HTMLDocument, portfolio: Portfolio, posts: IPost[]): Promise<IPage> => {
